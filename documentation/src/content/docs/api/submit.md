...
description: Submit source code for sandboxed execution
---
...
:::note[Design Note]
Idempotency keys are essential for judge systems. Network retries shouldn't re-execute the same code. We use UUIDs because they're universally understood and don't require server-side generation. If you don't send a key, we generate one for you - but then retries create new submissions.
:::
