...
impl LanguageEnvelope {
    ...
    pub fn get_metadata(&self) -> HashMap<String, String> {
        ...
        metadata.insert("startup_overhead_ms".to_string(), self.startup_overhead_ms.to_string());
...
impl LanguagePresets {
    ...
    fn register_java17_v1(&mut self) {
        let envelope = LanguageEnvelope {
            ...
            syscall_notes: Some("JVM requires many syscalls; filtering not recommended".to_string()),
        };
    ...
    fn register_python311_v1(&mut self) {
        let envelope = LanguageEnvelope {
            ...
            syscall_notes: Some("Python interpreter requires many syscalls; filtering not recommended".to_string()),
        };
