...
pub const OPENBLAS_THREADS_KEY: &str = "OPENBLAS_NUM_THREADS";
pub const OPENBLAS_THREADS_VALUE: &str = "1";
pub const OMP_THREADS_KEY: &str = "OMP_NUM_THREADS";
pub const OMP_THREADS_VALUE: &str = "1";
